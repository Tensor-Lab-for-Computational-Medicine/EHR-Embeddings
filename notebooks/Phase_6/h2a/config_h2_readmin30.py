...
class ConfigH2:
    def __init__(self):
        ...
        self.EMBEDDING_MODEL_DIR = os.path.join(self.NOTEBOOKS_DIR, 'Phase_5', 'embedding_model_results', 'text-embedding-005', 'readmission_30')
        self._LEGACY_MODEL_DIR = os.path.join(self.NOTEBOOKS_DIR, 'Phase_5', 'text-embedding-005', 'readmission_30')
        ...
        # Outputs
        self.OUTPUT_DIR = os.path.join(current_dir, 'h2_results', 'readmission_30')
