"""
Configuration file for XGBoost analysis using CLIMBR embeddings.
This config adapts the XGBoost analysis script to work with CLIMBR embeddings.
"""
...
class Config:
    ...
    EMBEDDING_DIR = BASE_DIR / "embeddings_StanfordShahLab_clmbr-t-base"  # Adjust model name as needed
    LABEL_DIR = EMBEDDING_DIR / "labels"
    OUTPUT_DIR = BASE_DIR / "xgboost_results_climbr"
    
    # === EXPERIMENTAL SETUP ===
    # For CLIMBR, we typically have one experimental arm
    REPRESENTATIONS = ["CLIMBR"]  # Single representation type
