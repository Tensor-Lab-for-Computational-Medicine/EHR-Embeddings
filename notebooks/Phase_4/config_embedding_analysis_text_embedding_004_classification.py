...
class Config:
    ...
    EMBEDDING_DIR = 'notebooks/Phase 4/Classification_Embeddings/embeddings_models_text-embedding-004'
    ...
    OUTPUT_DIR = 'notebooks/Phase 5/embedding_model_results/text-embedding-004-classification/' + TARGET_VARIABLE
