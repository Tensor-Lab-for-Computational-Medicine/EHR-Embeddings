...
class Config:
    ...
    EMBEDDING_DIR = 'notebooks\Phase 4\embeddings_abhinand_MedEmbed-small-v0.1'
    ...
    OUTPUT_DIR = 'notebooks/Phase 5/embedding_model_results/MedEmbed-small/' + TARGET_VARIABLE
