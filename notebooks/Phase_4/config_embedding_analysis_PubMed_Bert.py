...
class Config:
    ...
    EMBEDDING_DIR = 'notebooks\Phase 4\embeddings_NeuML_pubmedbert-base-embeddings'
    ...
    OUTPUT_DIR = 'notebooks/Phase 5/embedding_model_results/NeuML_pubmedbert-base-embeddings/' + TARGET_VARIABLE
