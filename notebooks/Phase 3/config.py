...
PROMPTS = {
    ...
    'P1': "The following is a summary of the first 24 hours of a patient's ICU stay. Generate a patient state embedding optimized for predicting in-hospital mortality from this data.",
    'P2': "The following is a summary of the first 24 hours of a patient's ICU stay. From the perspective of an experienced ICU physician, generate a clinical embedding that synthesizes this data to capture the patient's overall severity and primary risk factors.",
    'P3': "The following is a summary of the first 24 hours of a patient's ICU stay. Generate a clinical embedding that focuses on the relationships between physiological systems and the temporal evolution of key variables within this period.",
    'P4': "The following is a summary of the first 24 hours of a patient's ICU stay. Generate a clinical embedding that captures the patient's integrated state of physiological dysregulation. The embedding should represent the severity and dynamics of the acute illness presented in this initial window.",
    'P5': "The following is a summary of the first 24 hours of a patient's ICU stay. Generate a clinical embedding that is oriented around the patient's dominant pathophysiological process. Determine if the primary driver of risk appears to be cardiovascular, respiratory, septic, or metabolic in nature, and encode this assessment into the embedding."
}
