# generate_embeddings_gemini_exp.py
"""
Main script to generate embeddings in parallel using an efficient BATCHING strategy.
This version is configured to use the 'gemini-embedding-exp-03-07' model.
"""
import os
import time
import logging
...
# MODIFIED: Import from the new configuration file
from config_embedding_gemini_exp import (
    SERIALIZED_DATA_DIR,
...
def main():
    ...
    logging.info(f"Using experimental model: {MODEL_NAME}", extra=extra_dict)
    ...
    # NOTE: The BATCH_SIZE for gemini-embedding-exp-03-07 is 100
