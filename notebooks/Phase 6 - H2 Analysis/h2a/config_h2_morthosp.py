...
class ConfigH2:
    def __init__(self):
        ...
        self.BASELINE_MODEL_PATH = os.path.join(self.NOTEBOOKS_DIR, 'Phase 1 and 2', 'phase_1_outputs', 'mort_hosp', 'model_1_xgboost_baseline_calibrated.pkl')

        # Embedding model and data
        self.CHAMPION_ARM = 'F3_P5'  # text-embedding-004
        self.CHAMPION_MODEL_PATH = os.path.join(self.NOTEBOOKS_DIR, 'Phase 5', 'embedding_model_results', 'text-embedding-004', 'mort_hosp', f'model_{self.CHAMPION_ARM}_calibrated.pkl')
